...
public class EchoServer {
    ...
    public static void main(String[] zero) {
        ...
        // - numero de port
        // - active parametre controlant l'activation des noeuds
        ...
        try {
            ...
            // création d'un pool de nbthreads pour pouvoir répondre à nbthreads demandes simultanément
            int i = 1;
    ...
    public void run() {
        ...
        try {
            while (true) {
                ...
                int walltime = 60; // delai autorisé pour l'accomplissement de la tache en secondes
                ...
                while (((s == null) || (!(s.endsWith(";mfin"))))) {
                    //System.out.println("recup2 chaine a traiter " + s);
                    chaine = chaine + s;
                    s = in.readLine();
                ...
                if (error == "no") {
                    ...
                    //N.info();
                    N.classer_validation(chaine);
                    String r = N.classer(chaine);
