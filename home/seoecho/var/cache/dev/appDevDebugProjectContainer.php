...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'echobt' => 'getEchobtService',
            'echos' => 'getEchosService',
            'echov' => 'getEchovService',
            ...
            'jarowinkler' => 'getJarowinklerService',
            ...
            'smithwatermangotoh' => 'getSmithwatermangotohService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CrawlGooglePythonBundle', ($this->targetDirs[3].'/app/Resources/CrawlGooglePythonBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CrawlGooglePythonBundle', ($this->targetDirs[3].'/src/SEOecho/CrawlGooglePythonBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'echoSEOBundle', ($this->targetDirs[3].'/app/Resources/echoSEOBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'echoSEOBundle', ($this->targetDirs[3].'/src/SEOecho/echoSEOBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('W1qes3lVaw', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hEBCtMyxkU', 0, 'kmonb8ToxViObA7NLkixjo', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7ObkRIeH16', 0, 'kmonb8ToxViObA7NLkixjo', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('olu+Isjnq6', 0, 'kmonb8ToxViObA7NLkixjo', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'seo-echo', 'user' => 'seo-echo', 'password' => 'seo76ZEcho', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_94f610fe86f129c16b590146e2aa0545429a613d55c62db07db7776b6021b57d');
    ...
    /**
     * Gets the 'echobt' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SEOecho\echoSEOBundle\Services\Echobt A SEOecho\echoSEOBundle\Services\Echobt instance
     */
    protected function getEchobtService()
    {
        return $this->services['echobt'] = new \SEOecho\echoSEOBundle\Services\Echobt();
    }

    /**
     * Gets the 'echos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SEOecho\echoSEOBundle\Services\Echos A SEOecho\echoSEOBundle\Services\Echos instance
     */
    protected function getEchosService()
    {
        return $this->services['echos'] = new \SEOecho\echoSEOBundle\Services\Echos();
    }

    /**
     * Gets the 'echov' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SEOecho\echoSEOBundle\Services\Echov A SEOecho\echoSEOBundle\Services\Echov instance
     */
    protected function getEchovService()
    {
        return $this->services['echov'] = new \SEOecho\echoSEOBundle\Services\Echov($this);
    }
    ...
    /**
     * Gets the 'jarowinkler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SEOecho\echoSEOBundle\Services\JaroWinkler A SEOecho\echoSEOBundle\Services\JaroWinkler instance
     */
    protected function getJarowinklerService()
    {
        return $this->services['jarowinkler'] = new \SEOecho\echoSEOBundle\Services\JaroWinkler();
    }
    ...
    /**
     * Gets the 'smithwatermangotoh' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SEOecho\echoSEOBundle\Services\SmithWatermanGotoh A SEOecho\echoSEOBundle\Services\SmithWatermanGotoh instance
     */
    protected function getSmithwatermangotohService()
    {
        return $this->services['smithwatermangotoh'] = new \SEOecho\echoSEOBundle\Services\SmithWatermanGotoh();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'CrawlGooglePythonBundle', 8 => 'AsseticBundle', 9 => 'echoSEOBundle', 10 => 'DebugBundle', 11 => 'WebProfilerBundle', 12 => 'SensioDistributionBundle', 13 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SEOecho/CrawlGooglePythonBundle/Resources/views'), 'CrawlGooglePython');
        $instance->addPath(($this->targetDirs[3].'/src/SEOecho/echoSEOBundle/Resources/views'), 'echoSEO');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b30c91e4b1564.36606443')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CrawlGooglePythonBundle' => 'SEOecho\\CrawlGooglePythonBundle\\CrawlGooglePythonBundle',
                'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'echoSEOBundle' => 'SEOecho\\echoSEOBundle\\echoSEOBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CrawlGooglePythonBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SEOecho/CrawlGooglePythonBundle'),
                    'namespace' => 'SEOecho\\CrawlGooglePythonBundle',
                ),
                'AsseticBundle' => array(
                    'parent' => NULL,
                ...
                'echoSEOBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SEOecho/echoSEOBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'seo-echo',
            'database_user' => 'seo-echo',
            'database_password' => 'seo76ZEcho',
