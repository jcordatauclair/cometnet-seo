...
\textsc{\LARGE École polytechnique de l'université Grenoble-Alpes}\\[1.0cm] % Nom de l'université
...
\HRule \\[0.5cm]
{ \huge \bfseries Rapport de stage}\\[0.2cm] % Titre du document
\HRule \\[1.5cm]
